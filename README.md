...
| 5 | [Linguagem SQL (DDL/DML/DQL)](unidades/05-sql/linguagem-sql.md) · [Procedimentos Armazenados](unidades/05-sql/procedimentos-armazenados.md) · [Prática ENADE](unidades/05-sql/pratica-sql-enade.md) | ✅ |
...
| 7 | Bancos de Dados NoSQL — [Conceitos](unidades/07-nosql/nosql-conceitos.md) · [MongoDB na VM](unidades/07-nosql/mongodb-na-vm.md) · [De SQL para MongoDB](unidades/07-nosql/de-sql-para-mongodb.md) · [Prática Pokémon](unidades/07-nosql/pratica-mongodb.md) | ✅ |
